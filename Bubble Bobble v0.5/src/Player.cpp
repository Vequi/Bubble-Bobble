...
AppStatus Player::Initialise()
{
	...
	if (data.LoadTexture(Resource::IMG_PLAYER, "BubbleBobble_Art/Characters/bubSprite.png") != AppStatus::OK)
	{
	...
	sprite->AddKeyFrame((int)PlayerAnim::IDLE_RIGHT, { 0 * n, 0 * n, -n, n });
	sprite->AddKeyFrame((int)PlayerAnim::IDLE_RIGHT, { 2 * n, 0 * n, -n, n });
	...
	sprite->AddKeyFrame((int)PlayerAnim::FALLING_LEFT, { 0*n, 6*n, n, n });
	sprite->AddKeyFrame((int)PlayerAnim::FALLING_LEFT, { 1*n, 6*n, n, n });
	...
	for (i = 0; i < 2; ++i)
		sprite->AddKeyFrame((int)PlayerAnim::LEVITATING_RIGHT, {(float)i*n, 5*n, -n, n });
