...
enum class Tile {
	...
	L34BLOCKTL, L34BLOCK, L34BLOCK_NUMT1, L34BLOCK_NUMT2, L34BLOCK_NUMB1, L34BLOCK_NUMB2,
	...
	DOOR = 55,
	KEY_RED = 60, YELLOW_KEY, ITEM_CHERRY, ITEM_BANANA, ITEM_CAKE, ITEM_BOTTLE, ITEM_ICECREAM, ITEM_REDGEM,
