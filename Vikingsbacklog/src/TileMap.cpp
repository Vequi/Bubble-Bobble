...
void TileMap::InitTileDictionary()
{
	...
	dict_rect[(int)Tile::L1BLOCK_NUM] = { 0, 0, n, n };
	dict_rect[(int)Tile::L1PLAT_TCORNER] = { 0, n, n, n };
	dict_rect[(int)Tile::L1PLAT_T] = { 0, 2*n, n, n };
	dict_rect[(int)Tile::L1BLOCK] = { 0, 3*n, n, n };
	dict_rect[(int)Tile::L1BLOCK_LSHADE] = { 0, 4*n, n, n };

	dict_rect[(int)Tile::L1PLAT_LB] = { n,  0, n, n };
	dict_rect[(int)Tile::L1PLAT_LBRSHADET] = { n,  n, n, n };
	dict_rect[(int)Tile::L1PLAT_LBEDGE] = { n, 2*n, n, n };
	dict_rect[(int)Tile::L1PLAT_B] = { n, 3*n, n, n };
	dict_rect[(int)Tile::L1PLAT_RBEDGE] = { n, 4*n, n, n };

	dict_rect[(int)Tile::L1PLAT_LCORNER] = { 2 * n, 0, n, n };
	dict_rect[(int)Tile::L1PLAT_LBRSHADEB] = { 2 * n, n, n, n };
	dict_rect[(int)Tile::L1PLAT_LBEDGESHADE] = { 2 * n, 2*n, n, n };
	dict_rect[(int)Tile::L1PLAT_BSHADE] = { 2 * n, 3*n, n, n };
	dict_rect[(int)Tile::L1PLAT_REDGESHADE] = { 2 * n, 4*n, n, n };
	
	dict_rect[(int)Tile::L1PLAT_TCORNER_RSHADE] = { 3 * n, 0, n, n };
	dict_rect[(int)Tile::L1PLAT_LTEDGE] = { 3 * n, n, n, n };
	dict_rect[(int)Tile::L1PLAT_RTEDGE] = { 3 * n, 2*n, n, n };
	dict_rect[(int)Tile::L1PLAT_BRSHADE] = { 3 * n, 3*n, n, n };
	dict_rect[(int)Tile::L1PLAT_TR] = { 3 * n, 4*n, n, n };
...
AppStatus TileMap::Initialise()
{
	...
	if (data.LoadTexture(Resource::IMG_TILES, "images/level1tiles.png") != AppStatus::OK)
	{
